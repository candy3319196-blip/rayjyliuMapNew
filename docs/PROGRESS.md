...
| 2.1.2 | 引擎添加 rune.enable 判断 | ⬜ | |
| 2.1.3 | Hunting 跳过符文检查 | ⬜ | |
| 2.1.4 | FSM 条件注册符文状态 | ⬜ | |
...
| # | 任务 | 完成日期 | 备注 |
|---|------|---------|------|
| 2.2.1 | 添加 talery_anti_cheat 配置块 | ⬜ | |
| 2.2.2 | 新建 anti_cheat.py 状态 | ⬜ | |
| 2.2.3 | FSM 注册 anti_cheat 状态 | ⬜ | |
| 2.2.4 | Hunting 添加校验触发检测 | ⬜ | |
